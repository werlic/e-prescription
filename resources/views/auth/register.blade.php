          ...
          <div class="card bg-secondary border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
                ...
                <form method="POST" action="{{ route('register') }}" role="form">
                    ...
                    <div class="text-muted font-italic d-none"><small>password strength: <span class="text-success font-weight-700">strong</span></small></div>
                    <div class="form-group">
                        <div class="input-group input-group-merge input-group-alternative">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="ni ni-lock-circle-open"></i></span>
                        </div>
                        <input class="form-control" placeholder="Password" type="password" id="password-confirm" name="password_confirmation">
                        </div>
                    </div>
                    <div class="row my-4">
                        <div class="col-12">
